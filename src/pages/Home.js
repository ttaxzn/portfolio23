  ...
  return (
    <div className="App">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="text-6xl m-3 sm:text-8xl md:text-8xl lg:text-8xl text-[#283618] font-['Brandey']">
          A Developer.
        </div>
      ...
      <div className=" pt-10 flex flex-col w-full h-auto max-h-[800px] gap-10 md:flex-row justify-center items-center md:pr-10 md:pl-10 lg:pr-20 lg:pl-20 ">
        ...
        >
          <div className="relative pb-10">
            <div className="absolute right-7 top-7 text-2xl md:text-5xl md:right-14 md:top-14 text-[#283618] font-['Brandey']">
              Portfolio
            </div>
            <div className="absolute right-7 top-14 text-lg md:text-4xl md:right-14 md:top-28 text-[#283618] font-['Nunito']">
              React / JS / Tailwind
            </div>
          </div>
          <Link to="/portfolio">
        ...
        >
          <div className="relative pb-10">
            <div className="absolute right-7 top-7 text-2xl md:text-5xl md:right-14 md:top-14 text-[#fefae0] font-['Brandey']">
              Lumos
            </div>
            <div className="absolute right-7 top-14 text-lg md:text-4xl md:right-14 md:top-28 text-[#fefae0] font-['Nunito']">
              React / JS / TS
            </div>
          </div>
          <Link to="/lumos">
      ...
      <div className="flex flex-col justify-center items-center">
        <div className="text-6xl mt-20 sm:text-8xl md:text-8xl lg:text-8xl pt-20 md:pt-40 text-[#283618] font-['Brandey']">
          In Progress.
        </div>
        <div className="text-l m-8 sm:text-2xl md:text-2xl lg:text-2xl text-[#414833] text-center font-['Nunito']">
